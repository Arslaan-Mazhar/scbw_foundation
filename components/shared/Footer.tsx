...
const Footer = () => {
  return (
    <footer className='flexCenter mx-10 mb-24 animate-fade-in'>
     <div className='padding-container max-container flex w-full flex-col gap-14'>
       <div className='flex flex-col items-start justify-center gap-[10%] md:flex-row'>
         ...
         <div className='flex flex-wrap gap-10 sm:justify-between md:flex-1'>
           ...
           <div className='flex flex-col gap-5'>
             ...
             <ul className='regular-14 flex gap-4 text-gray-30 animate-pulse
             '>
       ...
       <div className='border bg-gray-20'>
        <p className='regular-14 w-full text-center text-gray-30'><span>2024 <b> SCBW Foundation </b> | All right reserved</span></p>
       </div>
     </div>
    </footer>
  )
