...
const About = () => {
  return (
    <section className="bg-gray-100 p-10 rounded-xl " >
      <div className="flex flex-col xl:flex-row gap-4 xl:mx-24 min-h-80 items-center justify-center ">
        ...
        <div className="w-full xl:w-3/4 xl:h-[41.5rem] bg-slate-900 rounded-xl">
           <h1 className="text-5xl text-white m-5 text-center lg:m-1">About Us</h1>
